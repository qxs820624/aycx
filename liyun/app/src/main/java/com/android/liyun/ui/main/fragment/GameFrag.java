...
public class GameFrag extends BaseFragment implements SensorEventListener {
    ...
    protected void initView() {
        ...
        mSensorManager = (SensorManager) UIUtils.getContext().getSystemService(SENSOR_SERVICE);//获取传感器管理服务
