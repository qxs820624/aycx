package com.android.liyun.wxapi;
...
import com.android.liyun.bean.WXAccessTokenEntity;
import com.android.liyun.bean.WXBaseRespEntity;
import com.android.liyun.bean.WXUserInfo;
...
//                showMsg(1,result);
                ...
                OkHttpUtils.get().url("https://api.weixin.qq.com/sns/oauth2/access_token")
                        .addParams("appid",ConstValues.APP_ID_WX)
                        .addParams("secret",ConstValues.APP_SECRET_WX)
        ...
        OkHttpUtils.get()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        SPUtil.putString(UIUtils.getContext(),"headUrl",headUrl);
