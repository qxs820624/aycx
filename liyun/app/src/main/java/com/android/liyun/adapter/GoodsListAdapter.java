...
public class GoodsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<GoodsListBean.GoodsBean> mDatas = new ArrayList<>();
...
//    }
    ...
    public void addDatas(List<GoodsListBean.GoodsBean> datas) {
        mDatas.addAll(datas);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        GoodsListBean.GoodsBean goodsBean = mDatas.get(pos);
...
//            view.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, height));
    ...
    public ArrayList<GoodsListBean.GoodsBean> getmDatas() {
        return mDatas;
    }
